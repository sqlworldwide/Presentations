/*
THANKS TO ALL SPONSORS, ORGANIZERS, VOLUNTERRS AND YOU ATTENDEES
Feedback: https://sqlb.it/?9386 (Please!! Please!!)
...
Using a local instance of SQL2022 CU1

I am not taking any question due to time constraint:
1. We can go to community zone and chat
2. Feel free to follow up via any of my contacts
3. Take my card and follow up later
*/
...
IF EXISTS (SELECT 1 FROM sys.databases WHERE [name] = N'backupmythdemo')
  BEGIN
    SET @SQL = 
      N'USE [master];
       ALTER DATABASE backupmythdemo SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
       USE [master];
