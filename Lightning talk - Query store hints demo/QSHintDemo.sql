/*
Script Name: QSHintDemo.sql
This code is copied from:
https://docs.microsoft.com/en-us/sql/relational-databases/performance/query-store-hints?view=azuresqldb-current

Modified by Taiob Ali   
SqlWorldWide.com  
January 20, 2022

Demo uses "PropertyMLS" database which can be imported from BACPAC located at
https://github.com/microsoft/sql-server-samples/blob/master/samples/features/query-store/PropertyMLS.bacpac
*/

/*
Connect to Azure SQL Database name PropertyMLS 
...
/*
The PropertySearchByAgent stored procedure has a parameter used to filter AgentId  
Looking at the statistics for AgentId, you will see that there is a big skew for AgentId 101
*/
...
/*
We can set the hint associated with the query_id returned in the previous result set
This example is adding a single hint. You can apply multiple query hints with a comma-separated list
Example:
